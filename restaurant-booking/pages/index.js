...
export default function Home() {
  ...
  const fetchBookings = async () => {
    try {
      const response = await axios.get('https://neinafull-bac.onrender.com/api/bookings');
  ...
  const handleBooking = async (e) => {
    ...
    try {
      const response = await axios.post('https://neinafull-bac.onrender.com/api/bookings', bookingData);
